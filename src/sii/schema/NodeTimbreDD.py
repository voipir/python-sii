...
from .types import UnsignedInteger, String, SiiRUT, SiiDTE, SiiFolio, SiiFecha, SiiFechaHora
...
class NodeTimbreDD(XMLNode):
    ...
    # CAF   = NodeCodigoAutFolio()  # Replaced with placeholder for raw XML string
    CAF   = String()                # Raw XML Placeholder
    TSTED = SiiFechaHora()
